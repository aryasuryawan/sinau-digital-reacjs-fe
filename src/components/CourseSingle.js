...
function CourseSingle() {
    ...
    const getDataProducts = async () => {
      const response = await fetch(`http://localhost:5000/course/${params?.id}`);
                    ...
                    <div className="box-border flex flex-wrap">
                      <div className="w-full md:w-1/6 "> 
                          ...
                          <div className="w-full md:w-5/6 pl-8 pr-2 align-middle my-6"> 
                            ...
                            <div className="badge badge-secondary font-bold text-sm p-4 my-5 ">
                              {product.category}
                            </div>
                            <div className="">
                           ...
                           <div className="bg-white sm:pt-8 lg:pt-4 ">
                              <div className="container mx-auto">       
                                <div className="box-border flex flex-wrap">
                                     ...
                                     <div className="my-8 w-full h-full md:w-2/6 bg-slate-100 rounded-lg border-slate-700 p-6">
                                          ...
                                          <span className="text-2xl text-blue-700 font-bold pb-2 mb-2"><FormatRupiah value={product.price}/></span>
